...
Description: This module handles the implementation of Data Validation and formatting
             ...
             Deprecated on 2025-01-16. Functionality of this module is now taken care
             of in export_excel.py using CTS_Example_Template.xlsx

Author: Urban Halpern
Original Creation: 2024-12-16
