...
if not os.path.exists(database_path):
    ...
    # Insert sample data
    data = [
        ('1234567890', 'Smith', 'John', 'A', '1980-01-01', '9673123456', '2024-12-31', '2024-06-15', 'D1234', 'MOD1', 150.73, 50.00, 20.00, 'Private Insurance'),
        ('0987654321', 'Doe', 'Jane', 'B', '1975-05-15', '9011654321', '2024-11-30', '2024-06-20', 'C4567', '24', 200.23, 75.00, 30.00, 'Medicare'),
        ('5678901234', 'Brown', 'Michael', 'C', '1990-09-20', '9601789012', '2025-01-15', '2024-06-25', 'H7890', 'GT', 300.47, 100.00, 40.00, 'None')
    ]
