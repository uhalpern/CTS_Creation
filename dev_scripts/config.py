...
validation_format_dict3 = {
    ...
    "date_columns":["DATE OF BIRTH", "COVERAGE EXPIRATION DATE", "DATE OF SERVICE"],
    ...
    "unprotected_columns": ["AMOUNT DUE", "SPEND DOWN", "CONTRACTUAL ADJUSTMENT", "ADJUSTMENT REASON", "NOTE"]
}
